    ...
    <>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .whyus-cta { padding: 1.75rem !important; flex-direction: column; align-items: flex-start !important; }
        }
      `}</style>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={styles.header}>
            ...
            <h2 style={styles.heading}>
              Why Beauty Academies<br />
              Trust Vipprow
            </h2>
            <p style={styles.subtext}>
              We're not just a digital agency. We're your growth partner — obsessed
              with one thing: making your beauty academy thrive.
            </p>
          </div>
          ...
          <div className="whyus-cta">
            <div>
              <p style={styles.ctaTagline}>Ready to grow your beauty academy?</p>
              <p style={styles.ctaSub}>Let's build your brand professionally.</p>
            </div>
            <div style={styles.ctaActions}>
              <a href="tel:+917974718311" className="btn-primary">Call Us Now →</a>
              <a href="https://portfolio.vipprow.com" target="_blank" rel="noreferrer" className="btn-outline">
                Our Portfolio
              </a>
            </div>
          </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { textAlign: "center", padding: "2rem 1.75rem" },
  iconWrap: {
    width: "60px",
    height: "60px",
    borderRadius: "14px",
  ...
  ctaActions: { display: "flex", gap: "1rem", flexWrap: "wrap" },
};
